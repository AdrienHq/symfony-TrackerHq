 ...
 */
final class Version20210906162636 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ingredient (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, quantity TINYINT(1) DEFAULT \'0\' NOT NULL, carbohydrate NUMERIC(10, 2) NOT NULL, fat NUMERIC(10, 2) NOT NULL, protein NUMERIC(10, 2) NOT NULL, sugar NUMERIC(10, 2) NOT NULL, energy NUMERIC(10, 2) NOT NULL, created_by VARCHAR(255) DEFAULT NULL, filename VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ingredient_category_ingredient (ingredient_id INT NOT NULL, category_ingredient_id INT NOT NULL, INDEX IDX_4C5D5FB8933FE08C (ingredient_id), INDEX IDX_4C5D5FB88DE4C5C7 (category_ingredient_id), PRIMARY KEY(ingredient_id, category_ingredient_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ingredient_quantity_in_recipe (id INT AUTO_INCREMENT NOT NULL, recipe_grams_id INT NOT NULL, ingredient_grams_id INT NOT NULL, grams INT DEFAULT NULL, INDEX IDX_C5B6D5B6F0EB6E04 (recipe_grams_id), INDEX IDX_C5B6D5B6F47D9B14 (ingredient_grams_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE ingredient_category_ingredient ADD CONSTRAINT FK_4C5D5FB8933FE08C FOREIGN KEY (ingredient_id) REFERENCES ingredient (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE ingredient_category_ingredient ADD CONSTRAINT FK_4C5D5FB88DE4C5C7 FOREIGN KEY (category_ingredient_id) REFERENCES category_ingredient (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ingredient_category_ingredient DROP FOREIGN KEY FK_4C5D5FB88DE4C5C7');
        $this->addSql('ALTER TABLE ingredient_category_ingredient DROP FOREIGN KEY FK_4C5D5FB8933FE08C');
        ...
        $this->addSql('DROP TABLE ingredient_category_ingredient');
        $this->addSql('DROP TABLE ingredient_quantity_in_recipe');
